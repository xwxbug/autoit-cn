...
If Not FileExists($SciTE_Dir) Then
	MsgBox(0 + 16 + 262144, "SciTEConfig", "Ã»ÓÐÕÒµ½ SciTE.exe ,³ÌÐòÍ£Ö¹. ")
	Exit
EndIf
;
;	ConsoleWrite('@@ Debug(' & @ScriptLineNumber & ') : $AutoIT3_Dir = ' & $AutoIT3_Dir & @crlf & '>Error code: ' & @error & @crlf) ;### Debug Console
...
If @error Then
	MsgBox(0 + 16 + 262144, "SciTEConfig", "SciTE Î´ÔËÐÐ,³ÌÐòÍË³ö.")
...
$h_tab0 = GUICtrlCreateTabItem("³£¹æÉèÖÃ")
...
;
$BaseY = 105
GUICtrlCreateGroup("³£¹æÉèÖÃ", $BaseX, $BaseY, 340, 80)
GUICtrlCreateLabel("±£´æ±à¼­µÄÎÄ¼þ±¸·ÝÊýÁ¿(0=ÎÞ):", $BaseX + 10, $BaseY + 15, 230, 20)
$h_Backups = GUICtrlCreateInput($Backups, $BaseX + 245, $BaseY + 12, 25, 20)
$H_ProperCase = GUICtrlCreateCheckbox("×Ô¶¯Çø·Öº¯ÊýÓë¹Ø¼ü×ÖµÄ´óÐ¡Ð´.", $BaseX + 10, $BaseY + 30)
$H_CheckUpdatesSciTE4AutoIt3 = GUICtrlCreateCheckbox("¼ì²é SciTE4AutoIT3 ¸üÐÂ.", $BaseX + 10, $BaseY + 50)
;
$BaseY = 195
GUICtrlCreateGroup("ÔØÈëµÄ AutoIt3 ¶¨Òå:", $BaseX, $BaseY, 340, 60)
...
;
$BaseY = 265
GUICtrlCreateGroup("AutoIt3 Ä¿Â¼ÉèÖÃ:", $BaseX, $BaseY, 340, 80)
...
GUICtrlCreateLabel("ÓÃ»§ Include Ä¿Â¼:", $BaseX + 10, $BaseY + 35, 110, 20)
...
;
$BaseY = 350
GUICtrlCreateGroup("AU3 ×ÖÌåÉèÖÃ", $BaseX, $BaseY, 340, 100)
$H_Syn_Mono_Change = GUICtrlCreateButton("ÐÞ¸Ä", $BaseX + 10, $BaseY + 15, 50, 20)
$H_Syn_Mono = GUICtrlCreateCheckbox("µÈ¿í×ÖÌå:" & $SYN_Font_Mono_Type, $BaseX + 70, $BaseY + 15, 220, 20)
$H_Syn_Mono_Size = GUICtrlCreateLabel("´óÐ¡:" & $SYN_Font_Mono_Size, $BaseX + 290, $BaseY + 17, 40, 20)
$H_Syn_Prop_Change = GUICtrlCreateButton("ÐÞ¸Ä", $BaseX + 10, $BaseY + 45, 50, 20)
$H_Syn_Prop = GUICtrlCreateCheckbox("±ÈÀý×ÖÌå:" & $SYN_Font_Prop_Type, $BaseX + 70, $BaseY + 45, 220, 20)
$H_Syn_Prop_Size = GUICtrlCreateLabel("´óÐ¡:" & $SYN_Font_Prop_Size, $BaseX + 290, $BaseY + 47, 40, 20)
...
EndIf
;
$H_Use_Tabs = GUICtrlCreateCheckbox("Ê¹ÓÃÖÆ±í·û(Tabs)", $BaseX + 10, $BaseY + 70)
GUICtrlCreateLabel("ÖÆ±í·û´óÐ¡:", $BaseX + 140, $BaseY + 73, 80, 20)
$H_Tab_Size = GUICtrlCreateInput($Tab_Size, $BaseX + 205, $BaseY + 73, 25, 20)
;
; Color Tab
$h_tab1 = GUICtrlCreateTabItem("ÑÕÉ«ÉèÖÃ")
$BaseY = 60
;determine current loaded definition files for SciTE
;$BaseY = 148
$H_Background_Label = GUICtrlCreateLabel("±³¾°É«:" & StringLower($Background_Color), $BaseX + 5, $BaseY, 150, 20)
$H_CaretLine_Label = GUICtrlCreateLabel("²åÈëÐÐÑÕÉ«:" & StringLower($CaretLine_Color), $BaseX + 5, $BaseY + 20, 150, 20)
$H_Background_Color = GUICtrlCreateButton("±³¾°", $BaseX + 170, $BaseY, 80, 20)
$H_CaretLine_Color = GUICtrlCreateButton("²åÈëÐÐ", $BaseX + 170, $BaseY + 20, 80, 20)
$BaseY = $BaseY + 50
...
GUICtrlCreateLabel("Ä¬ÈÏ±³¾°É«", $BaseX + 280, $BaseY - 10, 50, 30)
For $x = 1 To 16
	...
	$H_Syn_fColor[$x] = GUICtrlCreateButton("Ç°¾°", $BaseX + 245, $BaseY + 20 * $x, 40, 20)
	$H_Syn_bColor_Standard[$x] = GUICtrlCreateCheckbox("", $BaseX + 295, $BaseY + 20 * $x, 20, 20)
	$H_Syn_bColor[$x] = GUICtrlCreateButton("±³¾°", $BaseX + 320, $BaseY + 20 * $x, 40, 20)
Next
Update_Window()
...
If FileExists($AutoIT3_Dir & '\SciTE\Properties\au3.properties') Then
	...
	Else
		...
		$h_tab2 = GUICtrlCreateTabItem("¹¤¾ßÑ¡Ôñ")
		GUICtrlCreateLabel("Ñ¡ÔñÒª½ûÓÃÆôÓÃµÄ¹¤¾ßÏîÄ¿", 40, 50, 330)
...
$H_Update = GUICtrlCreateButton("¸üÐÂ", 10, 470, 70)
GUICtrlSetTip(-1, "Show changes in SciTE and save to SciTEUser.properties")
$H_NewScheme = GUICtrlCreateButton("ÐÂÖ÷Ìâ", 90, 470, 70)
GUICtrlSetTip(-1, "Ñ¡ÔñÐÂÑÕÉ«/×ÖÌåÖ÷Ìâ.")
GUICtrlSetState($H_NewScheme, $GUI_HIDE)
$H_Exit = GUICtrlCreateButton("ÍË³ö", 170, 470, 50)
$H_SciTE4AutoIT3Updates = GUICtrlCreateButton("¼ì²é SciTE4Autoit3 ¸üÐÂ", 230, 470, 170)
...
Func Update_Window()
	Local $x
	GUICtrlSetData($H_Syn_Mono, "µÈ¿í×ÖÌå:" & $SYN_Font_Mono_Type)
	GUICtrlSetData($H_Syn_Prop, "±ÈÀý×ÖÌå:" & $SYN_Font_Prop_Type)
	GUICtrlSetData($H_Syn_Mono_Size, "´óÐ¡:" & $SYN_Font_Mono_Size)
	GUICtrlSetData($H_Syn_Prop_Size, "´óÐ¡:" & $SYN_Font_Prop_Size)
...
Func SelectNewScheme()
	...
	Local $h_Ok = GUICtrlCreateButton("È·¶¨", 155, 60, 80, 33, 0)
	GUICtrlSetState(-1, $GUI_DEFBUTTON)
	Local $h_Cancel = GUICtrlCreateButton("È¡Ïû", 265, 60, 80, 33, 0)
