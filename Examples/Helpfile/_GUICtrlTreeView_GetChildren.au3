...
Func _Main () 
    ...
    GUICreate ( "TreeView Children" ,  400 ,  300 ) 
...
Item" ,  $x ),  $hTreeView ) 
      ...
      For  $y  =  0  To  2 
            $htmp_item  =  GUICtrlCreateTreeViewItem ( StringFormat ( "[%02d] New 
Item" ,  $y ),  $hItem [ $x ]) 
        Next 
    Next 
  ...
  MsgBox ( 4160 ,  "Information" ,  "Item 0 has Children? "  &  _GUICtrlTreeView_GetChildren ( $hTreeView ,  $hItem [ 0 ])) 
    MsgBox ( 4160 ,  "Information" ,  "Item 10 has Children? 
"  &  _GUICtrlTreeView_GetChildren ( $hTreeView ,  $hItem [ 10 ])) 
