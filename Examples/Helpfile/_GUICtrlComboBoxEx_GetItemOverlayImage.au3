...
Func _Main()
	...
	; 创建界面
	$hGUI = GUICreate(" ComboBoxEx Item Indent ", 400, 300)
	...
	_GUICtrlComboBoxEx_SetItemOverlayImage($hCombo, 2, 4)
	MsgBox(4160, "Information ", "Item Indent:" & _GUICtrlComboBoxEx_GetItemIndent($hCombo, 2) & _
			" Item Indent:" & _GUICtrlComboBoxEx_GetItemOverlayImage($hCombo, 4))
