 ...
 $hWnd = GUICreate ( "File Decyptor" ,  234 ,  178 ,  260 ,  238 ) 
 $InFileLabel = GUICtrlCreateLabel ( "Input File" ,  8 ,  0 ,  66 ,  17 ) 
 $InFileInput = GUICtrlCreateInput ( "" ,  8 ,  16 ,  169 ,  21 ) 
 $OutFileLabel = GUICtrlCreateLabel ( "Output File" ,  8 ,  48 ,  66 ,  17 ) 
 ...
 $EncryptButton = GUICtrlCreateButton ( "Decrypt File" ,  8 ,  144 ,  211 ,  25 ,  $WS_GROUP ) 
 GUISetState ( @SW_SHOW ) 
