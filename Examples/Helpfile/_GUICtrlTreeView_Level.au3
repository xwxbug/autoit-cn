...
Func _Main()
	...
	For $x = 0 To 3
		...
		For $y = 0 To 4
			...
			For $z = 1 To 5
				...
				$hChildItem[$iYItem + $z] = _GUICtrlTreeView_AddChild($hTreeView, $hChildItem[$iYItem], StringFormat( "[%02d] New
				Child" ,  $iYItem  +  $z ),  0 ,  3 )
	...
	Levl: %d" ,  $iRand ,  _GUICtrlTreeView_Level ( $hTreeView ,  $hChildItem [ $iRand ])))
