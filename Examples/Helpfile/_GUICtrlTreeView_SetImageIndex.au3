...
Func _Main()
	...
	For $x = 0 To UBound($hItem) - 1
		...
		Item" ,  $x  +  1 ),  $hRandomImage ,  $hRandomImage )
	Next
	...
	MsgBox(4160, "Information", StringFormat( "Item %d Image
	Index? %s" ,  $hRandomItem ,  _GUICtrlTreeView_GetImageIndex ( $hTreeView ,  $hItem [ $hRandomItem ])))
