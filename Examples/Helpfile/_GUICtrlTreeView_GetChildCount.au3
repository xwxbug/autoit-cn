...
Func _Main()
	...
	MsgBox(4160, "Information", StringFormat( "Child Count
	for item index %d: %d" ,  $iRand ,  _GUICtrlTreeView_GetChildCount ( $hTreeView ,  $hItem [ $iRand ])))
		...
		GUIDelete()
;### Tidy Error -> "endfunc" is closing previous "for" on line 41
	endfunc   ;==>_Main
