...
Item" ,  $x ),  4 ,  5 ) 
  ...
  MsgBox ( 4160 ,  "Information" ,  StringFormat ( "Index for 
Child Item %d: %d" ,  $iRand ,  _GUICtrlTreeView_Index ( $hTreeView ,  $hChildItem [ $iRand ]))) 
  ...
  MsgBox ( 4160 ,  "Information" ,  StringFormat ( "Index for 
Item %d: %d" ,  $iRand ,  _GUICtrlTreeView_Index ( $hTreeView ,  $hItem [ $iRand ]))) 
