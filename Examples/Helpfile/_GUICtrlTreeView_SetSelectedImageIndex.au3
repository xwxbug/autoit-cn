...
Func _Main()
	...
	MsgBox(4160, "Information", StringFormat( "Selected Image Index for Item Index 2?
	%d" ,  _GUICtrlTreeView_GetSelectedImageIndex ( $hTreeView ,  $hItem [ 2 ])))
	_GUICtrlTreeView_SetSelectedImageIndex($hTreeView, $hItem[2], 1)
	MsgBox(4160, "Information", StringFormat( "Selected
	Image Index for Item Index 2? %d" ,  _GUICtrlTreeView_GetSelectedImageIndex ( $hTreeView ,  $hItem [ 2 ])))
	_GUICtrlTreeView_SelectItem($hTreeView, $hItem[2])
