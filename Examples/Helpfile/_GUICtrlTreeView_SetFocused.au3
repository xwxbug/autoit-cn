...
Func _Main()
	...
	GUICreate("TreeView Focused", 400, 300)
	...
	MsgBox(4160, "Information", StringFormat( "Item %d
	Focused? %s" ,  $hRandomItem ,  _GUICtrlTreeView_GetFocused ( $hTreeView ,  $hItem [ $hRandomItem ])))
