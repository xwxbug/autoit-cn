 ; ******************************************************* 
 ; 示例1 - 打开带有基本示例页的浏览器, 将事件脚本插入到文档头部, 使得在点击文档时发出JavaScript提醒 
 ; ******************************************************* 
 #include  <IE.au3> 
 ...
 ; ******************************************************* 
 ; 示例2 - 打开带有基本示例页的浏览器, 将事件脚本插入到文档头部, 使得在右击文档时发出JavaScript提醒, 
 ...
 ; ******************************************************* 
 ; 示例3 - 打开带有基本示例页的浏览器, 当离开浏览页时将事件脚本插入到文档头部并提供取消操作的选项. 
 ; ******************************************************* 
 #include  <IE.au3> 
 $oIE = _IE_Example ( " basic " ) 
 ...
 ; ******************************************************* 
 ; 示例4 - 打开带有基本示例页的浏览器, 将事件脚本插入到文档头部以阻止在文档中选取文本 
 ; ******************************************************* 
 #include  <IE.au3> 
 $oIE = _IE_Example () 
 ...
 ; ******************************************************* 
 ; 示例5 - 以AutoIt主页打开浏览器, 将事件脚本插入到文档头部以阻止浏览任一链接的点击并将点击的链接地址记录到控制台 
 ; ******************************************************* 
 #include  <IE.au3> 
